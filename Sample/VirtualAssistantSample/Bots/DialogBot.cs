...
namespace VirtualAssistantSample.Bots
{
        ...
        where T : Dialog
    {
        ...
        IStatePropertyAccessor<UserState> userStateAccessor;

        public DialogBot(IServiceProvider serviceProvider, UserState userState, T dialog)
        {
            ...
            userStateAccessor = userState.CreateProperty<UserState>(nameof(_userState));
